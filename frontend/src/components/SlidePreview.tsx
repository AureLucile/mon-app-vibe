      ...
      >
        ...
        <div className="p-5 pt-5 h-full flex flex-col">
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="shrink-0 w-8 h-8 rounded-md bg-[#1E2761] text-white flex items-center justify-center font-bold text-xs">
              {slide.number}
            </div>
            <h4 className="font-bold text-[#1E2761] text-sm leading-tight">{title}</h4>
          </div>

          {/* Content placeholder */}
          <div className="flex-1 rounded-md border-2 border-dashed border-gray-200 bg-[#F8FAFC] p-4 flex flex-col justify-center">
